...
export const rightPanelEn = {
  ...
  workspaceTab: {
    ...
    setDuringCreation: 'Set during session creation',
    additionalDirectories: (count: number) => `Additional Directories (${count})`,
    addDirectory: '+ Add Directory',
    noAdditionalDirectories: 'No additional directories added',
